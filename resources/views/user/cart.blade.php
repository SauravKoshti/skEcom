                        ...
                        <table class="table shopping-summery text-center clean">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="action" data-title="Remove"><a href="remove-from-cart" class="text-muted"><i class="fi-rs-trash"></i></a></td>
                                </tr>
                                @endforeach
                                <tr>
                                    <td colspan="6" class="text-end">
                                        <a href="remove-from-cart" class="text-muted"> <i class="fi-rs-cross-small"></i> Clear Cart</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
