                    ...
                    <div class="col-lg-">
                        <div class="shop-product-fillter">
                            <div class="totall-product">
                                <p> We found <strong class="text-brand">{{ count($searchData) }}</strong> items for you!</p>
                            </div>
                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                    <a href="product-detail/{{ $productData->id }}">
                                        ...
                                        <div class="product-content-wrap">
                                            <div class="product-category">
                                                ...
                                                <a href="shop.html">{{ $productData->category->name }}</a>
                                            </div>
                                            <h2><a href="product-detail/{{ $productData->id }}">{{ $productData->name }}</a></h2>
                        ...
                        {{-- <div class="pagination-area mt-15 mb-sm-5 mb-lg-0">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-start">
                                    ...
                                    <li class="page-item"><a class="page-link" href="#">{{ $searchData->links() }}</a></li>
