    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                @if ($productData->category->parent_id != null )
                <span> {{ $productData->category->name  }} </span>
                @endif
            </div>
        </div>
                        ...
                        <div class="row mb-50">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info">
                                    <h2 class="title-detail">{{ $productData->name }}</h2>
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            <ins><span class="text-brand">{{ $productData->price }}</span></ins>
                                    ...
                                    <div class="detail-extralink">
                                        ...
                                        {{-- <div class="product-extra-link2">
                                            ...
                                            <a href="{{ route('addToCart',$productData->id) }}" class="button button-add-to-cart">Add to cart</a>
                                            <a aria-label="Add To Wishlist" class="action-btn hover-up" href="wishlist.php"><i class="fi-rs-heart"></i></a>
                                            <a aria-label="Compare" class="action-btn hover-up" href="compare.php"><i class="fi-rs-shuffle"></i></a>
                                        </div> --}}
                                    </div>
                                    <ul class="product-meta font-xs color-grey mt-50">
                                        ...
                                        <li>Availability:<span class="in-stock text-success ml-5">{{ $productData->stock }} Items In Stock</span></li>
                                    </ul>
                                </div>
                                <!-- Detail Info -->
                            </div>
