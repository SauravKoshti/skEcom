...
<link rel="shortcut icon" type="image/x-icon" href=" <?php echo {{ assets('assets/imgs/theme/favicon.ico') }}" ?> 2x>
<link rel="stylesheet" href="{{ assets('assets/css/main.css') }}">
<link rel="stylesheet" href="{{ assets('assets/css/custom.css') }}"></head>
...
<!-- Template  JS -->
<script src="{{ assets('assets/js/main.js?v=3.3')  }}"></script>
<script src="{{ assets('assets/js/shop.js?v=3.3')  }}"></script></body>
